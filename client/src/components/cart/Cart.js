...
const Cart = (props) => {
	...
	// This works but requires much more line of code
	// useEffect(() => {
	// 	if (props.fetchCartCtx) {
	// 		props.fetchCartCtx(cartCtx);
	// 	}
	// }, [cartCtx]);
		...
		<div className={classes['flex-wrapper']}>
			<div className={classes.wrapper}>
				<div className={classes.header}>
					{props.header ? props.header : 'My Cart:'}
				</div>
				<div className={classes['col-name']}>
					<div>Price</div>
				</div>
				<div
					className={classes['list-cart-item']}
					style={
						props.display === 'items'
